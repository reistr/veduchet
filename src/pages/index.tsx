      ...
      <Page>
        ...
        <section className="section section-illustrated">
          <div>
            ...
            <ul className="section__list">
              <li>
                Более 20 лет опыта работы в системе ЖКХ; в том числе:
                <ul>
                  <li>
                    рассчеты с населением (собственники, наниматели) за ЖКУ;
                  </li>
                  <li>
                    работа с большим объемом данных (до 40 тыс. лиц. счетов);
                  </li>
